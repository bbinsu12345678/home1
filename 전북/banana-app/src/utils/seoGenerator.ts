    ...
    const schemas = [
        {
            ...
            hasOfferCatalog: {
                ...
                name: '배관 서비스',
                itemListElement: [
                    { '@type': 'Offer', itemOffered: { '@type': 'Service', name: '변기막힘 해결' }, priceSpecification: { '@type': 'PriceSpecification', priceCurrency: 'KRW', minPrice: '50000', maxPrice: '300000', description: '단순 막힘 5만원~, 배관 해체 시 10~30만원 (현장에 따라 추가 비용 발생 가능)' } },
                    { '@type': 'Offer', itemOffered: { '@type': 'Service', name: '하수구막힘 해결' }, priceSpecification: { '@type': 'PriceSpecification', priceCurrency: 'KRW', minPrice: '50000', maxPrice: '350000', description: '단순 막힘 5만원~, 고압세척 15~35만원 (현장에 따라 추가 비용 발생 가능)' } },
                    { '@type': 'Offer', itemOffered: { '@type': 'Service', name: '싱크대막힘 해결' }, priceSpecification: { '@type': 'PriceSpecification', priceCurrency: 'KRW', minPrice: '50000', maxPrice: '250000', description: '단순 막힘 5만원~, 배관 교체 시 10~25만원 (현장에 따라 추가 비용 발생 가능)' } },
                    { '@type': 'Offer', itemOffered: { '@type': 'Service', name: '에어컨배관 청소' }, priceSpecification: { '@type': 'PriceSpecification', priceCurrency: 'KRW', minPrice: '60000', maxPrice: '200000', description: '드레인 뚫기 6만원~, 고압세척 포함 12~20만원 (현장에 따라 추가 비용 발생 가능)' } },
                    { '@type': 'Offer', itemOffered: { '@type': 'Service', name: '정화조막힘 해결' }, priceSpecification: { '@type': 'PriceSpecification', priceCurrency: 'KRW', minPrice: '150000', maxPrice: '500000', description: '정화조 뚫기 15만원~, 청소+세척 30~50만원 (현장에 따라 추가 비용 발생 가능)' } },
                    { '@type': 'Offer', itemOffered: { '@type': 'Service', name: '배관 고압세척' }, priceSpecification: { '@type': 'PriceSpecification', priceCurrency: 'KRW', minPrice: '150000', maxPrice: '500000', description: '배관 길이·구조에 따라 15~50만원 (현장에 따라 추가 비용 발생 가능)' } },
                ],
            },
        },
        {

    ...
    return (
        <header className="sticky top-0 z-50 bg-white border-b border-gray-200 shadow-sm max-w-4xl mx-auto w-full">
            <div className="container mx-auto px-4 h-16 flex items-center justify-between">
                ...
                {/* Right CTA */}
                <a href="tel:010-2115-3496" aria-label="긴급출동 전화 010-2115-3496" className="flex items-center gap-2 bg-banana-red text-white px-4 py-2 rounded-lg font-bold hover:bg-red-700 transition motion-safe:animate-pulse">
